...
ToSym[14]={WCnew[1,1,1,1]->WC[1,1,1,1],WCnew[1,1,1,2]->(WC[1,1,1,2]+WC[1,2,1,1])/2,WCnew[1,1,1,3]->(WC[1,1,1,3]+WC[1,3,1,1])/2,WCnew[1,1,2,1]->(WC[1,1,2,1]+WC[2,1,1,1])/2,WCnew[1,1,2,2]->(WC[1,1,2,2]+WC[2,2,1,1])/2,WCnew[1,1,2,3]->(WC[1,1,2,3]+WC[2,3,1,1])/2,WCnew[1,1,3,1]->(WC[1,1,3,1]+WC[3,1,1,1])/2,WCnew[1,1,3,2]->(WC[1,1,3,2]+WC[3,2,1,1])/2,WCnew[1,1,3,3]->(WC[1,1,3,3]+WC[3,3,1,1])/2,WCnew[1,2,1,2]->WC[1,2,1,2],WCnew[1,2,1,3]->(WC[1,2,1,3]+WC[1,3,1,2])/2,WCnew[1,2,2,1]->(WC[1,2,2,1]+WC[2,1,1,2])/2,WCnew[1,2,2,2]->(WC[1,2,2,2]+WC[2,2,1,2])/2,WCnew[1,2,2,3]->(WC[1,2,2,3]+WC[2,3,1,2])/2,WCnew[1,2,3,1]->(WC[1,2,3,1]+WC[3,1,1,2])/2,WCnew[1,2,3,2]->(WC[1,2,3,2]+WC[3,2,1,2])/2,WCnew[1,2,3,3]->(WC[1,2,3,3]+WC[3,3,1,2])/2,WCnew[1,3,1,3]->WC[1,3,1,3],WCnew[1,3,2,1]->(WC[1,3,2,1]+WC[2,1,1,3])/2,WCnew[1,3,2,2]->(WC[1,3,2,2]+WC[2,2,1,3])/2,WCnew[1,3,2,3]->(WC[1,3,2,3]+WC[2,3,1,3])/2,WCnew[1,3,3,1]->(WC[1,3,3,1]+WC[3,1,1,3])/2,WCnew[1,3,3,2]->(WC[1,3,3,2]+WC[3,2,1,3])/2,WCnew[1,3,3,3]->(WC[1,3,3,3]+WC[3,3,1,3])/2,WCnew[2,1,2,1]->WC[2,1,2,1],WCnew[2,1,2,2]->(WC[2,1,2,2]+WC[2,2,2,1])/2,WCnew[2,1,2,3]->(WC[2,1,2,3]+WC[2,3,2,1])/2,WCnew[2,1,3,1]->(WC[2,1,3,1]+WC[3,1,2,1])/2,WCnew[2,1,3,2]->(WC[2,1,3,2]+WC[3,2,2,1])/2,WCnew[2,1,3,3]->(WC[2,1,3,3]+WC[3,3,2,1])/2,WCnew[2,2,2,2]->WC[2,2,2,2],WCnew[2,2,2,3]->(WC[2,2,2,3]+WC[2,3,2,2])/2,WCnew[2,2,3,1]->(WC[2,2,3,1]+WC[3,1,2,2])/2,WCnew[2,2,3,2]->(WC[2,2,3,2]+WC[3,2,2,2])/2,WCnew[2,2,3,3]->(WC[2,2,3,3]+WC[3,3,2,2])/2,WCnew[2,3,2,3]->WC[2,3,2,3],WCnew[2,3,3,1]->(WC[2,3,3,1]+WC[3,1,2,3])/2,WCnew[2,3,3,2]->(WC[2,3,3,2]+WC[3,2,2,3])/2,WCnew[2,3,3,3]->(WC[2,3,3,3]+WC[3,3,2,3])/2,WCnew[3,1,3,1]->WC[3,1,3,1],WCnew[3,1,3,2]->(WC[3,1,3,2]+WC[3,2,3,1])/2,WCnew[3,1,3,3]->(WC[3,1,3,3]+WC[3,3,3,1])/2,WCnew[3,2,3,2]->WC[3,2,3,2],WCnew[3,2,3,3]->(WC[3,2,3,3]+WC[3,3,3,2])/2,WCnew[3,3,3,3]->WC[3,3,3,3]};
ToInd[14]={WCnew[1,1,1,1]->WC[1,1,1,1],WCnew[1,1,1,2]->WC[1,1,1,2]+WC[1,2,1,1],WCnew[1,1,1,3]->WC[1,1,1,3]+WC[1,3,1,1],WCnew[1,1,2,1]->WC[1,1,2,1]+WC[2,1,1,1],WCnew[1,1,2,2]->WC[1,1,2,2]+WC[2,2,1,1],WCnew[1,1,2,3]->WC[1,1,2,3]+WC[2,3,1,1],WCnew[1,1,3,1]->WC[1,1,3,1]+WC[3,1,1,1],WCnew[1,1,3,2]->WC[1,1,3,2]+WC[3,2,1,1],WCnew[1,1,3,3]->WC[1,1,3,3]+WC[3,3,1,1],WCnew[1,2,1,2]->WC[1,2,1,2],WCnew[1,2,1,3]->WC[1,2,1,3]+WC[1,3,1,2],WCnew[1,2,2,1]->WC[1,2,2,1]+WC[2,1,1,2],WCnew[1,2,2,2]->WC[1,2,2,2]+WC[2,2,1,2],WCnew[1,2,2,3]->WC[1,2,2,3]+WC[2,3,1,2],WCnew[1,2,3,1]->WC[1,2,3,1]+WC[3,1,1,2],WCnew[1,2,3,2]->WC[1,2,3,2]+WC[3,2,1,2],WCnew[1,2,3,3]->WC[1,2,3,3]+WC[3,3,1,2],WCnew[1,3,1,3]->WC[1,3,1,3],WCnew[1,3,2,1]->WC[1,3,2,1]+WC[2,1,1,3],WCnew[1,3,2,2]->WC[1,3,2,2]+WC[2,2,1,3],WCnew[1,3,2,3]->WC[1,3,2,3]+WC[2,3,1,3],WCnew[1,3,3,1]->WC[1,3,3,1]+WC[3,1,1,3],WCnew[1,3,3,2]->WC[1,3,3,2]+WC[3,2,1,3],WCnew[1,3,3,3]->WC[1,3,3,3]+WC[3,3,1,3],WCnew[2,1,2,1]->WC[2,1,2,1],WCnew[2,1,2,2]->WC[2,1,2,2]+WC[2,2,2,1],WCnew[2,1,2,3]->WC[2,1,2,3]+WC[2,3,2,1],WCnew[2,1,3,1]->WC[2,1,3,1]+WC[3,1,2,1],WCnew[2,1,3,2]->WC[2,1,3,2]+WC[3,2,2,1],WCnew[2,1,3,3]->WC[2,1,3,3]+WC[3,3,2,1],WCnew[2,2,2,2]->WC[2,2,2,2],WCnew[2,2,2,3]->WC[2,2,2,3]+WC[2,3,2,2],WCnew[2,2,3,1]->WC[2,2,3,1]+WC[3,1,2,2],WCnew[2,2,3,2]->WC[2,2,3,2]+WC[3,2,2,2],WCnew[2,2,3,3]->WC[2,2,3,3]+WC[3,3,2,2],WCnew[2,3,2,3]->WC[2,3,2,3],WCnew[2,3,3,1]->WC[2,3,3,1]+WC[3,1,2,3],WCnew[2,3,3,2]->WC[2,3,3,2]+WC[3,2,2,3],WCnew[2,3,3,3]->WC[2,3,3,3]+WC[3,3,2,3],WCnew[3,1,3,1]->WC[3,1,3,1],WCnew[3,1,3,2]->WC[3,1,3,2]+WC[3,2,3,1],WCnew[3,1,3,3]->WC[3,1,3,3]+WC[3,3,3,1],WCnew[3,2,3,2]->WC[3,2,3,2],WCnew[3,2,3,3]->WC[3,2,3,3]+WC[3,3,3,2],WCnew[3,3,3,3]->WC[3,3,3,3]};
...
RGEsSMEFTt=Join[RGEsSMEFTtPre[[1;;First[SMEFTFindParameter[Ge[3,3]]]]]/.ToLoopOrder[SMEFTLoopOrder]//Chop,RGEsSMEFTtPre[[First[SMEFTFindParameter[Ge[3,3]]]+1;;-1]]/.ToLoopOrder[SMEFTLoopOrder]];
];
